#!/usr/bin/python3
"""This class defines a student based on 10-student.py"""
...
class Student:
    ...
    def reload_from_json(self, json):
        """this is the function that replaces all attributes
        of the student instance with those in the json argument
        """
